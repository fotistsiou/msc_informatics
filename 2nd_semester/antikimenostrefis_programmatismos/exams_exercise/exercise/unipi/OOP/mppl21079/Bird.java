...
public class Bird extends Animal implements Feed, Serializable {
    /* Some specific fields of Bird. */
    private double weight;
    private int age;

    /* Bird ConstructorW. */
    public Bird(int animal_code, String animal_name, String animal_category, double animal_weight, int animal_age) {
    ...
    @Override
    public void ICanEat() {
        System.out.println("I am a bird and you can feed me!");
    }
}