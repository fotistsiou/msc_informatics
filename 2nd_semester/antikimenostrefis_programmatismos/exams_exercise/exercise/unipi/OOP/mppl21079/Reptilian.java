...
public class Reptilian extends Animal implements Feed, Serializable {
    /* Some specific fields of Reptilian. */
    private double weight;
    private int age;

    /* Reptilian Constructors. */
    public Reptilian(int animal_code, String animal_name, String animal_category, double animal_weight, int animal_age) {
    ...
    @Override
    public void ICanEat() {
        System.out.println("I am a reptilian and you can feed me!");
    }
}