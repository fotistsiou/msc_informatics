...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference image = storageReference.child("story_image_4.png");
        try {
        ...
        outputStoryText = findViewById(R.id.textView18);
        outputMoralText = findViewById(R.id.textView34);
        ...
        reference = database.getReference("story4/text");
        reference2 = database.getReference("story4/moral");
