...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StorageReference image = storageReference.child("story_image_1.png");
        try {
        ...
        outputStoryText = findViewById(R.id.textView12);
        outputMoralText = findViewById(R.id.textView28);
        ...
        reference = database.getReference("story1/text");
        reference2 = database.getReference("story1/moral");
